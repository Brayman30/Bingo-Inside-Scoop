		...
		extend: {
			...
			backgroundImage: {
				"gradient-radial-gold":
					"radial-gradient(circle at 30% 30%, hsl(51 99% 47% / 0.22), transparent 70%)",
				"gradient-radial-green":
					"radial-gradient(circle at 70% 70%, hsl(142 39% 22% / 0.18), transparent 75%)",
				"gradient-conic-brand":
					"conic-gradient(from 180deg at 50% 50%, hsl(51 99% 47%), hsl(142 39% 22%), hsl(201 100% 14%), hsl(51 99% 47%))",
				"gradient-brand-linear":
					"linear-gradient(135deg, hsl(201 100% 14%) 0%, hsl(142 39% 22%) 55%, hsl(51 99% 47%) 110%)",
			},
			boxShadow: {
				"brand-soft":
					"0 4px 16px -2px hsl(201 100% 14% / 0.25), 0 2px 4px -1px hsl(142 39% 22% / 0.15)",
				"brand-glow":
					"0 0 0 1px hsl(51 99% 47% / 0.4), 0 0 0 4px hsl(51 99% 47% / 0.15)",
			},
			animation: {
